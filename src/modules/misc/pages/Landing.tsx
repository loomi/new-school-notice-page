...
export const Landing = () => {
  ...
  return (
    <>
      <Head title="Home" description="Welcome to React Leap 🚀👩‍🚀" />
      <LC.Vertical
        color="white"
        minH="100vh"
        px="8"
        center
        bgImage={landingBg.src}
        bgPosition="center"
        bgSize="cover"
      >
        <LC.Vertical pos="relative" zIndex="banner" center>
          <LC.Vertical mb={8}>
            <Image src={reactLeapLetter.src} alt="React Leap" />
          </LC.Vertical>
